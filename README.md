...
# 🏖️🌍 Tech Krunch Blog <a name="about-project"></a>
This app allows users to browse through a collection of posts, interact with them by leaving comments, and liking posts.
...
- View the latest tech articles.
- Read  blog posts with detailed descriptions, photos, and comments.
- Leave comments on blog posts to share your thoughts.
- Like posts on your favorite stories.
...
```
### Setup
Clone or download the Tech Krunch repository to your local machine.
```sh
  git clone git@github.com:julzedz/tech-krunch.git
```
...
Feel free to check the <a href="https://github.com/julzedz/tech-krunch/issues">Issues page</a>.
